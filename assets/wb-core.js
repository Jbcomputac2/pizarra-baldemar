...
function loadAll() {
  ...
  if (WS.font) WB.font = WS.font; if (WS.theme) WB.theme = WS.theme; if (WS.paperIdx != null) WB.paperIdx = WS.paperIdx;
...
function save() {
  ...
  saveTimer = setTimeout(() => {
    ...
    WS.font = WB.font; WS.theme = WB.theme; WS.paperIdx = WB.paperIdx;
    try { localStorage.setItem(STORE_KEY, JSON.stringify(WS)); } catch (e) {}
    pushBoard(b);
    if (typeof refreshSidebar === 'function') refreshSidebar();
  }, 500);
